...
class SmartMoneyStrategy:
    ...
    def generate_signal(self, data: pd.DataFrame, current_position: str = None) -> Tuple[str, float, float, Dict]:
        ...
        if self.use_volume_filter:
            ...
            buy_filters_passed['volume'] = True # Filter nicht aktiv, gilt als bestanden
            sell_filters_passed['volume'] = True # Filter nicht aktiv, gilt als bestanden
        ...
        if self.use_key_levels:
            ...
            buy_filters_passed['key_levels'] = True # Filter nicht aktiv, gilt als bestanden
            sell_filters_passed['key_levels'] = True # Filter nicht aktiv, gilt als bestanden
        ...
        if self.use_pattern_recognition:
            ...
            buy_filters_passed['pattern'] = True # Filter nicht aktiv, gilt als bestanden
            sell_filters_passed['pattern'] = True # Filter nicht aktiv, gilt als bestanden
        ...
        if self.use_order_flow:
            ...
            buy_filters_passed['order_flow'] = True # Filter nicht aktiv, gilt als bestanden
            sell_filters_passed['order_flow'] = True # Filter nicht aktiv, gilt als bestanden
        ...
        if self.use_liquidity_sweep:
            ...
            buy_filters_passed['liquidity_sweep'] = True # Filter nicht aktiv, gilt als bestanden
            sell_filters_passed['liquidity_sweep'] = True # Filter nicht aktiv, gilt als bestanden


        # Überprüfe, ob alle aktivierten Filter für KAUFEN bestanden sind
        # Only check conditions for activated filters
        all_buy_filters_passed = all(buy_conditions_met) if buy_conditions_met else True # If no buy filters active, condition is True

        # Überprüfe, ob alle aktivierten Filter für VERKAUFEN bestanden sind
        # Only check conditions for activated filters
        all_sell_filters_passed = all(sell_conditions_met) if sell_conditions_met else True # If no sell filters active, condition is True
